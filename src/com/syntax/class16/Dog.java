...
public class Dog {
	...
	void displayDog() {
		...
		System.out.println("Dogs breed is "+breed+" and it has "+paws+ "paws and "+tails+" tail");
	}
	...
	public static void main(String [] args) {
		...
		//how to access static variables? static variable belong to the class -->accessed by className
